  ...
  module Formatter
    ...
    class Json
      ...
      def same_feature_as_previous_test_case?(feature)
        current_feature[:uri] == feature.file and current_feature[:line] == feature.location.line
      end
      ...
      def create_match_hash(step_source, result)
        unless result.undefined? or hook_source?(step_source)
      ...
      def create_result_hash(result)
        ...
        result_hash[:error_message] = create_error_message(result) if result.failed? or result.pending?
